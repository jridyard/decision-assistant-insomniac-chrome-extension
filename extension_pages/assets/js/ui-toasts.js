 ...
 */
 ...
 'use strict';
  ...
  // //    selectedAnimation = "animate__fade" // document.querySelector('#selectAnimation').value;
  ...
  // //  };
   ...
   function fireToast(json) {
    ...
    console.log('\x1b[31m%s\x1b[0m', `rytpe`, type);
  
    if (title) $('#toast-title').text(title)
    if (message) $('#toast-body').html(message);
    if (duration) $('#toast-container').attr('data-bs-delay', duration);
    ...
    toastAnimationExample.classList.remove("bg-primary", "bg-success", "bg-danger", "bg-warning", "bg-info", "bg-light", "bg-dark");
    toastAnimationExample.classList.add(type ? type : "bg-primary", selectedAnimation);
    toastAnimation = new bootstrap.Toast(toastAnimationExample);
    toastAnimation.show();
  };
